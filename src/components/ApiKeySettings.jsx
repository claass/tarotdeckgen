        ...
        {apiKey ? (
          <div className="p-4 bg-green-900/20 border border-green-700 rounded-lg text-sm text-green-300">
            ...
            <p className="mt-1 text-green-200/80">
              The application will use the Gemini API key provided via environment variables. Update the secret to change the key.
            </p>
          </div>
        ) : (
          <div className="p-4 bg-red-900/30 border border-red-700 rounded-lg text-sm text-red-300">
            ...
            <p className="mt-1 text-red-200/80">
              ...
              <code className="bg-red-800/40 px-1 rounded">GEMINI_API_KEY</code> (or Vite-compatible{' '}
              <code className="bg-red-800/40 px-1 rounded">VITE_GEMINI_API_KEY</code>) before running the app.
            </p>
          </div>
        )}
